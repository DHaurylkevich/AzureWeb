...
<main>
    <div class="centered-div">
        <form action="../models/process_log_in.php" method="post">
            <input style="width: 70%" type="email" name="email" id="email"  placeholder="Enter your email" autocomplete="on">

            <input style="width: 70%" type="password" name="password" id="password" placeholder="Enter your password" autocomplete="off">
